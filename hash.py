...
def banner():
	print (RR+'\n  Hash Cracker:'+WW+'3.0.1'+RR+'  BY:'+WW+'sksohel')
	print (W+'  ------------------------------------------')
...
def info():
	...
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Version  "+C+":"+W+" 3.0.1 (alpha)"+Y+"                        |")
        print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Author   "+C+":"+W+" sksohel"+Y+"                              |")        
	print (Y+" 0{===================================================}0\n")
...
def Update():
	if sys.platform == "linux" or sys.platform == "linux2":
		...
		os.system("curl https://raw.githubusercontent.com/sksohal7/hasher/main/wordlist.txt -o wordlist.txt")
